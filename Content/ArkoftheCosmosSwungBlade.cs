        ...
        public override void AI()
        {
            if (!initialized)
            {
                ...
                else if (SwingType is 0f or 1f)
                {
                    ...
                    Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), Owner.Center, Vector2.Zero, ModContent.ProjectileType<ArkoftheCosmosConstellation>(), (int)(Projectile.damage * ArkoftheCosmos.chainDamageMultiplier), 0f, Owner.whoAmI, (int)(Projectile.timeLeft / 2f)).timeLeft = (int)(Projectile.timeLeft / 2f);
                }
                else
                {
