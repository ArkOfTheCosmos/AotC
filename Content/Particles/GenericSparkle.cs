...
public class GenericSparkle : Particle
{
    ...
    public override string Texture => "AotC/Assets/Textures/Sparkle";
    ...
    public override void CustomDraw(SpriteBatch spriteBatch)
    {
        ...
        Texture2D value2 = ModContent.Request<Texture2D>("AotC/Assets/Textures/BloomCircle", (AssetRequestMode)2).Value;
